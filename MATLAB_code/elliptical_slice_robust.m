function [xx, cur_log_like, number_fn_evaluations, nu] = elliptical_slice_robust(xx, prior_covariance, log_like_fn, cur_log_like, angle_range, varargin)
