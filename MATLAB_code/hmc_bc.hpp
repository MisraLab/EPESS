...
namespace hmc_bc_model_namespace {
...
class hmc_bc_model : public prob_grad {
private:
    int N;
    int M;
    matrix_d x;
    vector<int> y;
public:
    hmc_bc_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "hmc_bc_model_namespace::hmc_bc_model";
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        try {
            ...
            for (int i = 1; i <= M; ++i) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(beta,i,"beta",1), 0, 1));
            }
            current_statement_begin__ = 15;
            for (int n = 1; n <= N; ++n) {
                current_statement_begin__ = 16;
                lp_accum__.add(bernoulli_log<propto__>(get_base1(y,n,"y",1), Phi(multiply(get_base1(x,n,"x",1),beta))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "hmc_bc_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
typedef hmc_bc_model_namespace::hmc_bc_model stan_model;
