function plotSimulatedGaussianEPESS( plotting_on_off, dimension, alphas, alpha_index, alpha, pseudoLogLikelihoodShifted, plot_axis_interval, grid_size, number_mixtures, mixture_weights, mixture_means, mixture_chol, EP_mean, EP_covariance, samples)
%Plot results of EPESS applied to the simulated mixture of Gaussians
    ...
    if plotting_on_off & dimension == 2
        ...
        subplot(length(alphas),2,1 + 3*(alpha_index-1));
        ...
        subplot(length(alphas),,2 + 3*(alpha_index-1));
