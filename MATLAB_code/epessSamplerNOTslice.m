function [ samples, nu ,number_fn_evaluations ] = epessSamplerNOTslice( number_samples , dimension, number_chains, logLikelihood, EP_mean, EP_chol, initial_point ) %axis_interval
